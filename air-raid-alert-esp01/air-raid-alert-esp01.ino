...
#define WIFI_SSID "SmartHome"   // Имя точки доступа WiFi
#define WIFI_PASS "DeViCe01"    // Пароль точки доступа WiFi

#define pinBuzzer   1  // Вывод бузера подключить к GPIO1 платы ESP01
#define pinRedLED   2  // Вывод красного светодиода подключить к GPIO2 платы ESP01
#define pinGreenLED 0  // Вывод зеленого светодиода подключить к GPIO0 платы ESP01
